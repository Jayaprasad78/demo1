...
mongoose.connect("mongodb+srv://jayaprasadb718:Jy85v3wdCrwMmy5t@test-pro-db.1sapcvc.mongodb.net/?retryWrites=true&w=majority", {
...
app.get('/', (req, res) => {
    res.render('contact'); // Assuming your EJS template file is named 'contact-form.ejs'
});
